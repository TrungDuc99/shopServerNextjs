            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 2, , 3]);
                        id = req.params.id;
                        _a = req.body, name = _a.name, password = _a.password, phone = _a.phone, address = _a.address;
                        return [4 /*yield*/, models_1.UserModel.findOneAndUpdate({ email: id }, { name: name, password: password, phone: phone, address: address })];
                    case 1:
                        payload = _b.sent();
                        return [2 /*return*/, res.json({ success: true, data: payload })];
                    case 2:
