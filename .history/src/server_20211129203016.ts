...
type Mutation {
  createProduct(name: String!, price:String!,description:String!, isActive: boolean! ): Product
  updateProduct(name: String!, price:String!,description:String!, isActive: boolean!, image:String!): Product
}
type Product {
