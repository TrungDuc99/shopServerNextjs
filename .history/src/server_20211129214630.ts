...
type Mutation {
  createProduct(name: String!, price:String!,description:String!,:String! ): Product
  updateProduct(name: String!, price:String!,description:String! ,description:String!,image:String!): Product
}
type Product {
